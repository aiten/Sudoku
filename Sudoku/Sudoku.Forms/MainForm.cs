...
namespace Sudoku.Forms
{
    public partial class MainForm : Form
    {
        ...
        private Sudoku.Solve.Sudoku _sudoku = new Sudoku.Solve.Sudoku();
        ...
        private volatile Sudoku.Solve.Sudoku _tsudoku;
        ...
        public void ThreadProc()
        {
            ...
            _tsudoku.CalcPossibleSolutions();
#if _DEBUG
            Console.WriteLine("OUT Thread");
#endif
            lock (_tlock)
            {
                _sudoku.FoundSolution -= new Sudoku.Solve.Sudoku.FoundSolutionHandler(OnFoundSolution);
                _tsudoku = null;
                _t = null;
            }
        }
...
//            BeginInvoke(new MethodInvoker( () => _toolStripStatusPossibleSolutions1.Text = outstr  ));
        ...
        private void LoadFile()
        {
            ...
            if (_fileName != null)
            {
                Sudoku.Solve.Sudoku newSudoku = Sudoku.Solve.Sudoku.Load(_fileName);
        ...
        private void NewToolStripMenuItemClick(object sender, EventArgs e)
        {
            ...
            _sudoku = new Sudoku.Solve.Sudoku();
            _fileName = null;
            SetCaption();
            SetButtons();
        }
