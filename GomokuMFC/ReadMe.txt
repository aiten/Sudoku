========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : Gomoku
========================================================================


Diese Gomoku-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
res\Gomoku.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei Gomoku.rc eingebunden.
...
res\Toolbar.bmp
    ...
    aktualisieren Sie IDR_MAINFRAME TOOLBAR in Gomoku.rc, um Schaltflächen für die
    Symbolleiste hinzuzufügen.
/////////////////////////////////////////////////////////////////////////////

Der Klassen-Assistent erstellt einen Dokumenttyp und eine Ansicht(View):

GomokuDoc.h, GomokuDoc.cpp - das Dokument
    	Diese Dateien enthalten die Klasse CGomokuDoc. Bearbeiten Sie diese Dateien,
  	um Ihre speziellen Dokumentdaten hinzuzufügen und das Speichern und Laden von 
	Dateien zu implementieren (mit Hilfe von CGomokuDoc::Serialize).

GomokuView.h, GomokuView.cpp - die Ansicht des Dokuments
    	Diese Dateien enthalten die Klasse CGomokuView.
    	CGomokuView-Objekte werden verwendet, um CGomokuDoc-Objekte anzuzeigen.
...
StdAfx.h, StdAfx.cpp
	...
	Gomoku.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
